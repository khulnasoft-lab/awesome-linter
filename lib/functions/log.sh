...
LOG_FILE="${LOG_FILE:-"awesome-linter.log"}"
...
AWESOME_LINTER_INITIALIZATION_LOG_GROUP_TITLE="Awesome-Linter initialization"
export AWESOME_LINTER_INITIALIZATION_LOG_GROUP_TITLE
