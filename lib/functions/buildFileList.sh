...
function IssueHintForFullGitHistory() {
  ...
  info "See https://github.com/awesome-linter/awesome-linter#get-started"
...
function BuildFileList() {
  ...
  PARALLEL_RESULTS_FILE_PATH="${AWESOME_LINTER_PRIVATE_OUTPUT_DIRECTORY_PATH}/awesome-linter-parallel-results-build-file-list.json"
  ...
  FILE_ARRAYS_DIRECTORY_PATH="${AWESOME_LINTER_PRIVATE_OUTPUT_DIRECTORY_PATH}/awesome-linter-file-arrays"
