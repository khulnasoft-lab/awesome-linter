...
control "awesome-linter-environment-variables" do
  impact 1
  title "Awesome-Linter environment variables check"
  desc "Check that environment variables that Awesome-Linter needs are defined."
...
control "awesome-linter-uninstalled-packages" do
  impact 1
  title "Awesome-Linter uninstalled packages check"
  desc "Check that packages that Awesome-Linter doesn't need are not installed."
...
###############################################
control "awesome-linter-installed-pypi-packages" do
  impact 1
  title "Awesome-Linter installed PyPi packages check"
  desc "Check that PyPi packages that Awesome-Linter needs are installed."
