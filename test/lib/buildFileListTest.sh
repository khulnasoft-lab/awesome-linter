...
git config --global user.email "awesome-linter@example.com"
git config --global user.name "Awesome-linter"
...
function BuildFileArraysAnsibleGitHubWorkspaceTest() {
  ...
  local FILE_ARRAYS_DIRECTORY_PATH="/tmp/awesome-linter-output/awesome-linter-file-arrays"
