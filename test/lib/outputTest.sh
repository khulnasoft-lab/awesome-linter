...
TEMP_WORKSPACE="$(pwd)/awesome-linter-output"
...
RemoveAnsiColorCodesFromFileTest() {
  ...
  local TEST_CASE_FILE_WITH_ANSI_COLOR_CODES="test/data/output/ansi-color-codes/awesome-linter-parallel-stdout-ARM"
  local EXPECTED_TEST_CASE_FILE_WITHOUT_ANSI_COLOR_CODES="test/data/output/ansi-color-codes/awesome-linter-parallel-stdout-ARM-no-ANSI-color-codes"
  local INPUT_FILE
