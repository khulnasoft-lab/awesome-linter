...
function ValidateAwesomeLinterSummaryOutputPathTest() {
  local FUNCTION_NAME
  FUNCTION_NAME="${FUNCNAME[0]}"
  info "${FUNCTION_NAME} start"

  AWESOME_LINTER_SUMMARY_OUTPUT_PATH="/non/existing/file"
  if ValidateAwesomeLinterSummaryOutputPath; then
    fatal "AWESOME_LINTER_SUMMARY_OUTPUT_PATH=${AWESOME_LINTER_SUMMARY_OUTPUT_PATH} should have failed validation when AWESOME_LINTER_SUMMARY_OUTPUT_PATH is set to a non-existing file"
  else
    info "AWESOME_LINTER_SUMMARY_OUTPUT_PATH=${AWESOME_LINTER_SUMMARY_OUTPUT_PATH} failed validation as expected"
  fi
  unset AWESOME_LINTER_SUMMARY_OUTPUT_PATH

  AWESOME_LINTER_SUMMARY_OUTPUT_PATH="$(pwd)"
  if ValidateAwesomeLinterSummaryOutputPath; then
    fatal "AWESOME_LINTER_SUMMARY_OUTPUT_PATH=${AWESOME_LINTER_SUMMARY_OUTPUT_PATH} should have failed validation when AWESOME_LINTER_SUMMARY_OUTPUT_PATH is set to a directory"
  else
    info "AWESOME_LINTER_SUMMARY_OUTPUT_PATH=${AWESOME_LINTER_SUMMARY_OUTPUT_PATH} failed validation as expected"
  fi
  unset AWESOME_LINTER_SUMMARY_OUTPUT_PATH

  AWESOME_LINTER_SUMMARY_OUTPUT_PATH="${0}"
  if ! ValidateAwesomeLinterSummaryOutputPath; then
    fatal "AWESOME_LINTER_SUMMARY_OUTPUT_PATH=${AWESOME_LINTER_SUMMARY_OUTPUT_PATH} should have passed validation when AWESOME_LINTER_SUMMARY_OUTPUT_PATH is set to a file"
  else
    info "AWESOME_LINTER_SUMMARY_OUTPUT_PATH=${AWESOME_LINTER_SUMMARY_OUTPUT_PATH} passed validation as expected"
  fi
  unset AWESOME_LINTER_SUMMARY_OUTPUT_PATH
...
ValidateAwesomeLinterSummaryOutputPathTest
